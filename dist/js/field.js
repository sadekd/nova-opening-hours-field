...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-opening-hours-field', __webpack_require__(4));
    Vue.component('detail-nova-opening-hours-field', __webpack_require__(7));
    Vue.component('form-nova-opening-hours-field', __webpack_require__(10));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        this.openingHours = _extends({}, __WEBPACK_IMPORTED_MODULE_0__const__["a" /* EMPTY_WEEK */], _.omit(this.field.value, 'exceptions'));
    },

    computed: {
        openingsForWeek: function openingsForWeek() {
            return _.map(this.openingHours, function (i, k) {
                return {
                    name: k,
                    label: k,
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.openingsForWeek, function(k) {
      return _c("boolean-icon", { key: k.name, attrs: { value: k.value } })
    }),
    1
  )
}
    ...
    [
      _c("template", { slot: "value" }, [
        _c(
          ...
          _vm._l(_vm.openingHours, function(intervals, dayNameAsKey) {
            return _c("tr", [
              _c("td", [_vm._v(_vm._s(_vm.__(dayNameAsKey)))]),
              _vm._v(" "),
              intervals.length
                ? _c("td", [_vm._v(_vm._s(intervals.join(", ")))])
                : _c("td", [_vm._v(_vm._s(_vm.__("closed")))])
            ])
          }),
          0
        )
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        this.openingHours = _extends({}, __WEBPACK_IMPORTED_MODULE_1__const__["a" /* EMPTY_WEEK */], _.omit(this.field.value, 'exceptions'));
        this.exceptions = this.field.value.exceptions || {};
    },


    computed: {
        exceptionDates: function exceptionDates() {
            return _this.exceptions.filter(function () {
                return true;
            });
        }
    },
    ...
    methods: {
        ...
        toggleExceptionDateModal: function toggleExceptionDateModal() {
            this.exceptionDateModal = !this.exceptionDateModal;
        },
        handleExceptionDateChange: function handleExceptionDateChange(date) {
            console.log(date);
            this.newExceptionDate = date;
        },
        addExceptionDate: function addExceptionDate(date) {
            if (!this.exceptions[date]) {
                this.$set(this.exceptions, date, []);
            }
            this.exceptionDateModal = false;
        },
        removeExceptionDate: function removeExceptionDate(date) {
            if (this.exceptions[date]) {
                this.$delete(this.exceptions, date);
            }
        },
        addExceptionInterval: function addExceptionInterval(date) {
            var intervals = this.exceptions[date];
            intervals.push("10:00-13:00");
            this.$set(this.exceptions, date, intervals);
        },
        removeExceptionInterval: function removeExceptionInterval(date, index) {
            var intervals = this.exceptions[date];
...
var update = __webpack_require__(21)("48e4f680", content, false, {});
...
// module
exports.push([module.i, "\ntable.exceptions td[data-v-c023248a] {\n    border-top-width: 0 !important;\n}\n.align-text-top[data-v-c023248a]{\n    vertical-align: text-top !important;\n}\n", ""]);
    ...
    [
      _c(
        ...
        [
          _c(
            "table",
            { staticClass: "openingHours table w-full" },
            [
              _vm._l(_vm.openingHours, function(intervals, dayNameAsKey) {
                return _c("tr", [
                  _c("td", [_vm._v(_vm._s(_vm.__(dayNameAsKey)))]),
                        ...
                        _vm._l(intervals, function(interval, intervalIndex) {
                          return _c("div", { staticClass: "interval" }, [
                            _c("input", {
                              directives: [
                                {
                                  ...
                                  rawName: "v-model",
                                  value:
                                    _vm.openingHours[dayNameAsKey][
                                      intervalIndex
                                    ],
                                  expression:
                                    "openingHours[dayNameAsKey][intervalIndex]"
                                }
                              ],
                              staticClass:
                              ...
                              domProps: {
                                value:
                                  _vm.openingHours[dayNameAsKey][intervalIndex]
                              },
                              on: {
                    ...
                    _c(
                      "button",
                      {
                        ...
                        on: {
                          click: function($event) {
                            $event.preventDefault()
                            return _vm.addInterval(dayNameAsKey)
                          }
                        }
                      },
                      [_vm._v("+\n                    ")]
              ...
              _vm._v(" "),
              _c("tr", { staticClass: "exceptions" }, [
                _c("td", { staticClass: "align-text-top pt-3" }, [
                  _c("p", [_vm._v(_vm._s(_vm.__("Exceptions")))])
                ]),
                _vm._v(" "),
                _c("td", [
                  Object.keys(_vm.exceptions).length
                    ? _c(
                        "div",
                        _vm._l(_vm.exceptions, function(
                          exceptionIntervals,
                          exceptionDateAsKey
                        ) {
                          return _c(
                            "table",
                            {
                              key: "exceptions" + exceptionDateAsKey,
                              staticClass: "exceptions"
                            },
                            [
                              _c("tr", [
                                _c("td", { staticClass: "border-t-0" }, [
                                  _c("p", [_vm._v(_vm._s(exceptionDateAsKey))])
                                ]),
                                _vm._v(" "),
                                _c("td", [
                                  _c(
                                    "button",
                                    {
                                      ...
                                      attrs: {
                                        title: "Add exception interval"
                                      },
                                      on: {
                                        click: function($event) {
                                          $event.preventDefault()
                                          return _vm.addExceptionInterval(
                                            exceptionDateAsKey
                                          )
                                        }
                                      }
                                  ...
                                  _c(
                                    ...
                                    {
                                      staticClass: "btn btn-default btn-danger",
                                      attrs: { title: "Remove exception" },
                                      on: {
                                        click: function($event) {
                                          $event.preventDefault()
                                          return _vm.removeExceptionDate(
                                            exceptionDateAsKey
                                          )
                                        }
                                      }
                              ...
                              _vm._v(" "),
                              _vm._l(exceptionIntervals, function(
                                exceptionInterval,
                                exceptionIntervalIndex
                              ) {
                                return _c(
                                  "tr",
                                  {
                                    key:
                                      exceptionDateAsKey +
                                      _vm.exceptions[exceptionDateAsKey].length
                                  },
                                  [
                                    _c("td", [
                                      _c("input", {
                                        directives: [
                                          {
                                            ...
                                            expression:
                                              "exceptions[exceptionDateAsKey][exceptionIntervalIndex]"
                                          }
                                        ],
                                        staticClass:
                                          "form-control form-input form-input-bordered",
                                        ...
                                        domProps: {
                                          value:
                                            _vm.exceptions[exceptionDateAsKey][
                                              exceptionIntervalIndex
                                            ]
                                        },
                                        on: {
                                    ...
                                    _c("td", [
                                      _c(
                                        "button",
                                        {
                                          ...
                                          attrs: {
                                            title: "Remove exception interval"
                                          },
                                          on: {
                                            click: function($event) {
                                              $event.preventDefault()
                                              return _vm.removeExceptionInterval(
                                                exceptionDateAsKey,
                                                exceptionIntervalIndex
                                              )
                                            }
                  ...
                  _c(
                    "button",
                    {
                      ...
                      on: {
                        click: function($event) {
                          $event.preventDefault()
                          return _vm.toggleExceptionDateModal()
                        }
                      }
                    },
                    [_vm._v("+\n                    ")]
                ...
                ? _c("modal", [
                    _c(
                      "form",
                      {
                        ...
                        staticStyle: { "min-width": "24rem" },
                        on: {
                          submit: function($event) {
                            $event.preventDefault()
                            return _vm.addExceptionDate(_vm.newExceptionDate)
                          }
                        }
                      },
                      [
                        _c(
                          ...
                          [
                            _c(
                              "p",
                              { staticClass: "text-2xl text-center pb-4" },
                              [_vm._v("Add new exception date")]
                            ),
                            _vm._v(" "),
                            _c("date-time-picker", {
                              staticClass:
                              ...
                              attrs: {
                                value: _vm.newExceptionDate,
                                placeholder: _vm.newExceptionDate,
                                "date-format": "Y-m-d",
                                "alt-ormat": "Y-m-d",
                                "enable-time": false,
                              ...
                              on: { change: _vm.handleExceptionDateChange }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "btn-wrapper bg-30 px-6 py-3 text-right"
                          },
                          [
                            _c(
                              "button",
                              {
                                staticClass:
                                  "btn text-80 font-normal h-9 px-3 btn-link",
                                attrs: { type: "button" },
                                on: {
                                  click: function($event) {
                                    $event.preventDefault()
                            ...
                            _c(
                              "button",
                              {
                                ...
                                attrs: {
                                  disabled: _vm.newExceptionDate === null,
                                  type: "submit"
                                }
                              },
                              [
